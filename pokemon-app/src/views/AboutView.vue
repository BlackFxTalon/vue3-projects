  ...
  <div class="about">
    ...
    >
      ...
      <div class="flex justify-center">
        <img class="w-48" loading="lazy" decoding="async" :src="pokemon.sprites.front_shiny" alt="image" width="200" height="200">
        <img class="w-48" loading="lazy" decoding="async" :src="pokemon.sprites.back_shiny" alt="image" width="200" height="200">
      </div>
